...
#            print "Non-seamless one found current->{0}, prev->{1}, GAP: {2}".format(current, prev, gap)
    ...
    def _init_graph(self, meaningful_words):
        ...
        '''
        print "meaningful_words inside the _init_gragh is {}".format(meaningful_words)
        G = nx.Graph()
...
#            print self._opt_component(each)
        ...
        print "DEBUG non-meaningful_pos_lst is {}".format(non_meaning_pos_lst)
